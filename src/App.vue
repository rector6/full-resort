    ...
    <nav class="navbar sticky">
      ...
      <div class="nav-link">
        <ul v-show="!mobile" class="navigation">
          ...
          <li>
            <router-link to="/about">FIND LOCATION</router-link>
          </li>
          <li>
            <router-link to="/search">SEARCH LAG&LAT</router-link>
          </li>
        </ul>
        <div class="icon">
          <i
        ...
        <transition name="mobile-nav">
          <ul v-show="mobileNav" class="dropdown-nav">
            ...
            <li>
              <router-link to="{ name: 'Products&Services' }"
            ...
            <li>
              <router-link to="{ name: 'CastTracker' }"
                >CastTracker</router-link
              >
            </li>
            <li>
